defmodule DienerHansBot.CommandReceiver do
  ...
  defmodule ServerImpl do
    ...
    def process_update(%{update_id: update_id} = update) do
      Logger.debug fn -> {"[#{__MODULE__}] Process update: #{inspect(update)}", [update_id: update_id]} end
